...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */
/*    _nxe_tftp_client_create                             PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  CALLS                                                                 */ 
/*                                                                        */  
/*    _nx_tftp_client_create                Actual client create call     */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT    status;
    ...
    if ((ip_ptr == NX_NULL) || (ip_ptr -> nx_ip_id != NX_IP_ID) ||   
        (tftp_client_ptr == NX_NULL) || (tftp_client_ptr -> nx_tftp_client_id == NX_TFTP_CLIENT_ID) || 
        (pool_ptr == NX_NULL))
        return(NX_PTR_ERROR);

    /* Check for valid IP version*/
                               
    status =  _nx_tftp_client_create(tftp_client_ptr, tftp_client_name, ip_ptr, pool_ptr);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nx_tftp_client_create                              PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
UINT    status;
    ...
    tftp_client_ptr -> nx_tftp_client_id =  NX_TFTP_CLIENT_ID;
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */  
/*    _nxe_tftp_client_delete                             PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  CALLS                                                                 */ 
/*                                                                        */ 
/*    _nx_tftp_client_delete                Actual client delete call     */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT    status;
    ...
    /* Check for invalid input pointers.  */                
    if ((tftp_client_ptr == NX_NULL) || (tftp_client_ptr -> nx_tftp_client_id != NX_TFTP_CLIENT_ID))
        return(NX_PTR_ERROR);
    ...
    status =  _nx_tftp_client_delete(tftp_client_ptr);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nx_tftp_client_delete                              PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */  
/*    _nxe_tftp_client_set_interface                      PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  CALLS                                                                 */ 
/*                                                                        */ 
/*    _nx_tftp_client_set_interface         Actual set interface call     */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT    status;
    ...
    /* Call actual client delete function.  */
    status =  _nx_tftp_client_set_interface(tftp_client_ptr, if_index);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */   
/*    _nx_tftp_client_set_interface                       PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */     
/*    _nxe_tftp_client_error_info_get                     PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  CALLS                                                                 */ 
/*                                                                        */  
/*    _nx_tftp_client_error_info_get         Actual get error info call   */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT    status;
    ...
    status =  _nx_tftp_client_error_info_get(tftp_client_ptr, error_code, error_string);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nx_tftp_client_error_info_get                      PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */  
/*    _nxe_tftp_client_file_close                         PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  CALLS                                                                 */ 
/*                                                                        */ 
/*    _nx_tftp_client_file_close            Actual client file close      */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT    status;
    ...
    status =  _nx_tftp_client_file_close(tftp_client_ptr);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nx_tftp_client_file_close                          PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*                                            data packet                 */ 
/*    nx_udp_socket_send                    Send UDP data packet          */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT        status;
    ...
    if (tftp_client_ptr -> nx_tftp_client_state == NX_TFTP_STATE_WRITE_OPEN)
    {
        ...
        status =  nx_packet_allocate(tftp_client_ptr -> nx_tftp_client_packet_pool_ptr, &packet_ptr, NX_UDP_PACKET, NX_NO_WAIT);
        ...
        *buffer_ptr =    (UCHAR) ((UCHAR) (tftp_client_ptr -> nx_tftp_client_block_number & 0xFF));
        ...
        status = nx_udp_socket_send(&(tftp_client_ptr -> nx_tftp_client_socket), packet_ptr, 
...
UINT        status;
    ...
    status = _nx_tftp_client_file_open_internal(tftp_client_ptr, file_name, server_ip_address, open_type, wait_option);
...
/*    nx_udp_socket_send                    Send UDP data packet          */ 
/*    nx_udp_source_extract                 Extract IP and port from msg  */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT        matching = NX_FALSE;
    ...
    tftp_client_ptr -> nx_tftp_client_server_ip = server_ip_address;
    ...
    *buffer_ptr++ =  NX_NULL;
    ...
    if (open_type == NX_TFTP_OPEN_FOR_WRITE)
    {
        ...
        status = nx_udp_source_extract(packet_ptr, &ip_address, &port);


        /* Check for an invalid server IP address.  */
        if(ip_address == tftp_client_ptr -> nx_tftp_client_server_ip)
        {
            matching = NX_TRUE;
        }
        else
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nxe_tftp_client_file_read                          PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  CALLS                                                                 */ 
/*                                                                        */
/*    _nx_tftp_client_file_read              Actual client file read      */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT    status;
    ...
    status =  _nx_tftp_client_file_read(tftp_client_ptr, packet_ptr, wait_option);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nx_tftp_client_file_read                           PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
UCHAR       resend_ACK_packet = NX_FALSE;
    ...
    if (code == NX_TFTP_CODE_DATA)
    {
        ...
        /* Allocate a new packet for the ACK message.   */

        status =  nx_packet_allocate(tftp_client_ptr -> nx_tftp_client_packet_pool_ptr, &ack_packet, NX_UDP_PACKET, wait_option);
        ...
        *buffer_ptr =    (UCHAR) (block_number & 0xFF);
        ...
        status = nx_udp_socket_send(&(tftp_client_ptr -> nx_tftp_client_socket), ack_packet, 
                                     tftp_client_ptr -> nx_tftp_client_server_ip, 
                                     tftp_client_ptr -> nx_tftp_client_server_port);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */  
/*    _nxe_tftp_client_file_write                         PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  CALLS                                                                 */ 
/*                                                                        */
/*    _nx_tftp_client_file_write            Actual client file write      */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT    status;
    ...
    status =  _nx_tftp_client_file_write(tftp_client_ptr, packet_ptr, wait_option);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */    
/*    _nx_tftp_client_file_write                          PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nxe_tftp_client_packet_allocate                    PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  CALLS                                                                 */ 
/*                                                                        */  
/*    _nx_tftp _client_file_write           Actual client file write      */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT    status;
    ...
    status =  _nx_tftp_client_packet_allocate(pool_ptr, packet_ptr, wait_option);
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nx_tftp_client_packet_allocate                     PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
UINT    status;
    ...
    status =  nx_packet_allocate(pool_ptr, packet_ptr, NX_UDP_PACKET, wait_option);
