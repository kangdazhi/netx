...
/*    interface_index                       Interface to check status on  */
...
UINT status;
    ...
    if (needed_status &
        (ULONG)(~(NX_IP_INITIALIZE_DONE | NX_IP_ADDRESS_RESOLVED | NX_IP_LINK_ENABLED | NX_IP_ARP_ENABLED |
                  NX_IP_UDP_ENABLED | NX_IP_TCP_ENABLED | NX_IP_IGMP_ENABLED |
                  NX_IP_RARP_COMPLETE | NX_IP_INTERFACE_LINK_ENABLED)))
    {
