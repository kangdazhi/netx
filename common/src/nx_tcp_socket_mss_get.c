...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function retrieves TCP Maximum Segment Size (MSS) for the      */
...
NX_IP *ip_ptr;
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_TCP_SOCKET_MSS_GET, ip_ptr, socket_ptr, socket_ptr -> nx_tcp_socket_mss, socket_ptr -> nx_tcp_socket_state, NX_TRACE_TCP_EVENTS, 0, 0)
