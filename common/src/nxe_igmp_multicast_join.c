...
UINT status;
    ...
    /*
       Validate the interface.  For backward compatibility, this service assumes multicast join
       on the primary interface, which is nx_ip_interface[0].
     */
    if (ip_ptr -> nx_ip_interface[0].nx_interface_valid == 0)
    {
