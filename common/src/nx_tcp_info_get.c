                       ...
                       ULONG *tcp_retransmit_packets)
{
    ...
    NX_TRACE_IN_LINE_INSERT(NX_TRACE_TCP_INFO_GET, ip_ptr, ip_ptr -> nx_ip_tcp_bytes_sent, ip_ptr -> nx_ip_tcp_bytes_received, ip_ptr -> nx_ip_tcp_invalid_packets, NX_TRACE_TCP_EVENTS, 0, 0)
