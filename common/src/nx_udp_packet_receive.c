...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function receives an UDP packet from the IP receive processing */
...
NX_UDP_HEADER *udp_header_ptr;
    ...
    do
    {
        ...
        if (socket_ptr -> nx_udp_socket_port == port)
        {
            ...
            ip_ptr -> nx_ip_udp_bytes_received +=          packet_ptr -> nx_packet_length - sizeof(NX_UDP_HEADER);
    ...
    if ((socket_ptr -> nx_udp_socket_port != port) || (socket_ptr -> nx_udp_socket_id != NX_UDP_ID))
    {
