...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nxe_smtp_client_create                             PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*  CALLS                                                                 */ 
/*                                                                        */ 
/*    _nx_smtp_client_create            Actual SMTP client create service */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    Application Code                                                    */ 
...
UINT status;
    ...
    status =  _nx_smtp_client_create(client_ptr, ip_ptr, client_packet_pool_ptr, username, password,
...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _nx_smtp_client_create                              PORTABLE C      */ 
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Yuxin Zhou, Microsoft Corporation                                   */
...
/*    SMTP Server over IPv4 networks. It also creates the TCP             */
...
NX_SMTP_CLIENT_MAIL    *mail_ptr;
    ...
    client_ptr -> nx_smtp_server_address = server_address;
...
UINT                    close_connection = NX_FALSE;
    ...
    while (status == NX_SUCCESS)  
    {
        ...
        if (client_ptr -> nx_smtp_client_cmd_state == NX_SMTP_CLIENT_STATE_GREETING)
        {
            ...
            status =  nx_tcp_client_socket_connect(&client_ptr -> nx_smtp_client_socket, 
...
NX_SMTP_CLIENT_MAIL         *mail_ptr;
    ...
    packet_payload = pool_ptr -> nx_packet_pool_payload_size - sizeof(NX_TCP_HEADER) - sizeof(NX_IP_HEADER);
