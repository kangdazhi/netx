...
UINT    status;
    ...
    if ((ftp_client_ptr == NX_NULL) || (ftp_client_ptr -> nx_ftp_client_id != NX_FTP_CLIENT_ID))
        return(NX_PTR_ERROR);
                             ...
                             CHAR *password, ULONG wait_option)
{
    ...
    return (_nx_ftp_client_connect_internal(ftp_client_ptr, server_ip, username, password, wait_option));
}
...
/*    nx_tcp_client_socket_connect          Connect to FTP server         */
...
/*                                                                        */
/**************************************************************************/
UINT  _nx_ftp_client_connect_internal(NX_FTP_CLIENT *ftp_client_ptr, ULONG server_ip, CHAR *username, 
                                      CHAR *password, ULONG wait_option)
{
...
UINT        status;
    ...
    status =  nx_tcp_client_socket_connect(&(ftp_client_ptr -> nx_ftp_client_control_socket), server_ip, NX_FTP_SERVER_CONTROL_PORT, wait_option); 
...
UINT    status;
    ...
    if ((ip_ptr == NX_NULL) || (ip_ptr -> nx_ip_id != NX_IP_ID) || 
        (ftp_client_ptr == NX_NULL) || (ftp_client_ptr -> nx_ftp_client_id == NX_FTP_CLIENT_ID) || 
        (pool_ptr == NX_NULL))
        return(NX_PTR_ERROR);
...
UINT    status;
    ...
    ftp_client_ptr -> nx_ftp_client_id =  NX_FTP_CLIENT_ID;
...
UINT    status;
    ...
    /* Check for invalid input pointers.  */
    if ((ftp_client_ptr == NX_NULL) || (ftp_client_ptr -> nx_ftp_client_id != NX_FTP_CLIENT_ID) || (directory_name == NX_NULL))
        return(NX_PTR_ERROR);
...
UINT    status;
    ...
    /* Check for invalid input pointers.  */
    if ((ftp_client_ptr == NX_NULL) || (ftp_client_ptr -> nx_ftp_client_id != NX_FTP_CLIENT_ID) || (packet_ptr == NX_NULL))
        return(NX_PTR_ERROR);
...
UINT    status;
    ...
    /* Check for invalid input pointers.  */
    if ((ftp_client_ptr == NX_NULL) || (ftp_client_ptr -> nx_ftp_client_id != NX_FTP_CLIENT_ID) || (file_name == NX_NULL))
        return(NX_PTR_ERROR);
...
/*    nx_tcp_client_socket_connect          Connect to server data socket */
/*    nx_tcp_socket_receive                 Receive response from server  */ 
/*    nx_tcp_socket_send                    Send request to server        */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
...
ULONG       temp =        0;
...

    {
        ...
        ftp_client_ptr -> nx_ftp_client_data_socket.nx_tcp_socket_connect_ip = ip_address;
    ...
    status =  nx_tcp_client_socket_connect(&(ftp_client_ptr -> nx_ftp_client_data_socket), 
